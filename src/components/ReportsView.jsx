  ...
  return (
    <div>
      <div className="flex gap-1.5 mb-4 bg-white/60 rounded-xl p-1 overflow-x-auto">
        ...
        <button
          onClick={() => setSubTab("reserve")}
          className="flex-1 py-2 rounded-lg text-xs font-semibold transition whitespace-nowrap"
          style={{
            background: subTab === "reserve" ? "linear-gradient(135deg, #148A7A, #0A5C54)" : "transparent",
            color: subTab === "reserve" ? "white" : "#0A5C54",
          }}
        >
          Reserve
        </button>
