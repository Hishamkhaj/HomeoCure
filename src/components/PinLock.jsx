...
import { Leaf, Delete, Lock } from "lucide-react";

// Main app PIN. Change this to whatever 4-digit PIN you want.
const APP_PIN = "1234";
// Separate PIN specifically for the Income section. Change independently of the main PIN.
export const INCOME_PIN = "5678";

export default function PinLock({
  onUnlock,
  pin = APP_PIN,
  storageKey = "homeocure-unlocked",
  title = "HomeoCure",
  ...
  return (
    <div
      className={fullScreen ? "min-h-screen flex flex-col items-center justify-center px-6" : "flex flex-col items-center justify-center px-2 py-10 rounded-2xl"}
      style={{ background: fullScreen ? "linear-gradient(180deg, #F4FAF8 0%, #E3F3EF 50%, #F4FAF8 100%)" : "transparent" }}
    >
      <div
