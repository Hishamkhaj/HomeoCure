...
// Simple 4-function calculator modal. onUse(value) is called with the final number when the user confirms.
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-end sm:items-center justify-center z-50" onClick={onClose}>
      <div className="bg-white rounded-t-3xl sm:rounded-3xl w-full max-w-sm p-6" onClick={(e) => e.stopPropagation()}>
        ...
        <div
          className="rounded-xl px-4 py-4 mb-4 text-right text-3xl font-bold overflow-x-auto"
