...
import { Plus, X, AlertTriangle, Pencil, Trash2, Search, RotateCcw, Droplet, Pill, EyeOff, Filter, Archive } from "lucide-react";
...
export default function PharmacyView() {
  const [pharmacySubTab, setPharmacySubTab] = useState("products"); // "products" | "inventory" | "reserve"
  ...
  return (
    <div>
      <div className="flex gap-1.5 mb-4 bg-white/60 rounded-xl p-1">
        <button
          onClick={() => setPharmacySubTab("products")}
          className="flex-1 py-2 rounded-lg text-xs font-semibold transition"
          style={{
            background: pharmacySubTab === "products" ? "linear-gradient(135deg, #148A7A, #0A5C54)" : "transparent",
            color: pharmacySubTab === "products" ? "white" : "#0A5C54",
          }}
        >
          Products
        </button>
        <button
          ...
          className="flex-1 py-2 rounded-lg text-xs font-semibold transition"
          style={{
            background: pharmacySubTab === "inventory" ? "linear-gradient(135deg, #148A7A, #0A5C54)" : "transparent",
            color: pharmacySubTab === "inventory" ? "white" : "#0A5C54",
          }}
        >
          Inventory
        </button>
        <button
          onClick={() => setPharmacySubTab("reserve")}
          className="flex-1 py-2 rounded-lg text-xs font-semibold transition"
          style={{
            background: pharmacySubTab === "reserve" ? "linear-gradient(135deg, #148A7A, #0A5C54)" : "transparent",
            color: pharmacySubTab === "reserve" ? "white" : "#0A5C54",
          }}
        >
          Reserve
        </button>
