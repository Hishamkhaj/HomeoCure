...
function statsForRange(entries, start, end) {
  let count = 0, income = 0, mr = 0, cash = 0, upi = 0, card = 0, patientIncome = 0, productIncome = 0;
  entries.forEach((e) => {
  ...
  return { count, income, mr, profit: income - mr, cash, upi, card, patientIncome, productIncome };
}
